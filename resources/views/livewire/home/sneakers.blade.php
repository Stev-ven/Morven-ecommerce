<div>
    <div class="groupings pt-[30px] mx-[30px]">
        <h1 class="group-title mt-[10px] text-2xl font-semibold text-gray-600">Men's {{ ucfirst($all_sneakers[0]['subcategory'] ?? 'Sneakers') }}</h1>
        {{-- @dd(session('cart')); --}}
