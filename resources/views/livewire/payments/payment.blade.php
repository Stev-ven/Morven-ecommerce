    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span
                        class="text-sm font-medium text-gray-700 hidden sm:inline">{{ $deliveryOption === 'pickup' ? 'Pickup' : 'Delivery' }}</span>
                </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1 space-y-6">
                ...
                @if ($isGuest)
                    <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <button wire:click="showLoginModal"
                                class="text-[#4F39F6] hover:text-[#3d2bc4] font-medium text-sm flex items-center gap-1">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="email" wire:model.blur="guestEmail"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#4F39F6] focus:ring-2 focus:ring-[#4F39F6]/20 transition-all"
                                    placeholder="you@example.com" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$">
                                @error('guestEmail')
                            ...
                            <div class="p-4 bg-gray-50 rounded-xl">
                                <label class="flex items-start gap-3 cursor-pointer">
                                    <input type="checkbox" wire:model="createAccount"
                                        class="w-5 h-5 text-[#4F39F6] border-gray-300 rounded focus:ring-[#4F39F6] mt-0.5">
                                    <div>
                                        <span class="text-sm font-medium text-gray-800">Create an account for faster
                                            checkout next time</span>
                                        <p class="text-xs text-gray-600 mt-1">Track orders, save addresses, and get
                                            exclusive offers</p>
                                    </div>
                                </label>
                            </div>
                ...
                @else
                    <div
                        class="bg-gradient-to-r from-[#4F39F6]/10 to-[#6366F1]/10 rounded-2xl p-6 border-2 border-[#4F39F6]/20">
                        <div class="flex items-center gap-4">
                            <div
                                class="w-12 h-12 bg-[#4F39F6] rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                <p class="font-semibold text-gray-800">Signed in as {{ $guestName }}</p>
                ...
                {{-- <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div wire:click="setPaymentMethod('card')"
                            ...
                            <div class="flex items-center gap-4">
                                <div class="flex-shrink-0">
                                    <div
                                        class="w-12 h-12 rounded-full flex items-center justify-center {{ $paymentMethod === 'card' ? 'bg-[#4F39F6] text-white' : 'bg-gray-100 text-gray-600' }}">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between">
                                        ...
                                        @if ($paymentMethod === 'card')
                                            <svg class="w-5 h-5 text-[#4F39F6]" fill="currentColor"
                                                viewBox="0 0 20 20">
                        ...
                        <!-- Mobile Money -->
                        <div wire:click="setPaymentMethod('mobile_money')"
                            ...
                            <div class="flex items-center gap-4">
                                <div class="flex-shrink-0">
                                    <div
                                        class="w-12 h-12 rounded-full flex items-center justify-center {{ $paymentMethod === 'mobile_money' ? 'bg-[#4F39F6] text-white' : 'bg-gray-100 text-gray-600' }}">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div wire:click="setPaymentMethod('cash')"
                            ...
                            <div class="flex items-center gap-4">
                                <div class="flex-shrink-0">
                                    <div
                                        class="w-12 h-12 rounded-full flex items-center justify-center {{ $paymentMethod === 'cash' ? 'bg-[#4F39F6] text-white' : 'bg-gray-100 text-gray-600' }}">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between">
                                        <h3 class="font-semibold text-gray-800">Cash
                                            {{ $deliveryOption === 'pickup' ? 'on Pickup' : 'on Delivery' }}</h3>
                            ...
                            <div class="space-y-4">
                                @if ($paymentMethod === 'card')
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Expiry
                                                Date</label>
                                ...
                                @else
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Mobile
                                            Number</label>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8 lg:sticky lg:top-24">
                    ...
                    <div class="space-y-3 mb-6 pt-4 border-t border-gray-200">
                        ...
                        <div class="flex justify-between text-gray-600">
                            <span>Delivery</span>
                            <span
                                class="font-medium">{{ $delivery > 0 ? 'GHS ' . number_format($delivery, 2) : 'FREE' }}</span>
                        </div>
